...
public:
	...
	****************************************/
	...
	ofxGuiGroup Group_WebCam;
		...
		ofxToggle b_WebCam_Mirror;
		ofxToggle b_WebCam_Gray;
		
	ofxGuiGroup Group_Ripple;
		ofxToggle b_UseRippleShader_toWebCam;
		ofxFloatSlider Ripple_Gain;
		ofxFloatSlider Ripple_Space;
		ofxFloatSlider Ripple_source;
