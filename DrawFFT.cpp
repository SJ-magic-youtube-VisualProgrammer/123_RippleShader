...
/******************************
******************************/
void DRAW_FFT::setup(const AUDIO_FFT& fft)
{
	/********************
	********************/
	print_separatoin();
	printf("> setup : Draw AUDIO_FFT\n");
	fflush(stdout);
...
0--3
******************************/
void DRAW_FFT::Refresh_vboVerts(const AUDIO_FFT& fft)
{
	/********************
	********************/
...
/******************************
******************************/
void DRAW_FFT::Refresh_vboColor(const AUDIO_FFT& fft)
{
	/********************
	********************/
	ofColor col;
...
/******************************
******************************/
void DRAW_FFT::update(const AUDIO_FFT& fft)
{
	Refresh_vboVerts(fft);
	Refresh_vboColor(fft);
}
...
/******************************
******************************/
void DRAW_FFT::draw(ofFbo& fbo, const AUDIO_FFT& fft)
{
	fbo.begin();
		/********************
		********************/
		...
		********************/
		{
			...
			ofDrawCircle(ofs.x + space_per_bar * xX, ofs.y - BarHeight / fft.get_max_of_Afilter() * 1.0/* 0 dB = x 1.0 */, 3/* size of circle */);
		}
